...
ENT.Base 			= "base_gmodentity" -- Ignore
ENT.Type 			= "anim" -- Ignore
ENT.PrintName 		= "Dr. Kleiner" -- Spawn menu name
ENT.Category		= "Persona - Example Mod" -- Category it will be in in the spawn menu
ENT.DataName 		= "example" -- The name used in the autorun file: PERSONA["MUST MATCH WHATS HERE IN QUOTES"].Name
ENT.Author 			= "Cpt. Hazama" -- Your name

ENT.Spawnable = true
ENT.AdminOnly = false -- Set this to true if only Admins can spawn it

	--|| IGNORE EVERYTHING BELOW HERE||--
	
ENT.Contact 		= "" -- Useless junk V
ENT.Purpose 		= ""
ENT.Instructions 	= ""
---------------------------------------------------------------------------------------------------------------------------------------------
if (CLIENT) then
